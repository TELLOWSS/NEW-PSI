...
const sources: TbmEvidenceSource[] = [{
    ...
    kind: 'manual',
    title: '7월 철골 작업계획',
    text: '고소작업대와 개구부 주변 작업이 예정되어 추락 방지조치를 중점 관리한다.',
...
describe('external AI handoff', () => {
    ...
    it('parses fenced JSON into an editable draft and translations', () => {
        ...
        const raw = `\`\`\`json
        {
          ...
          "translations": {"vi-VN":"1. Nội dung đào tạo"}
        }
        \`\`\``;
