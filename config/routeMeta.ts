...
export const routeMetaMap: Record<Page, RouteMeta> = {
    ...
    'education-return': createMeta({
        ...
        menuVisibleInDeveloperMode: true,
        fallbackTitle: '교육 환류',
        emptyStateMessage: '교육 환류로 연결할 분석 기록이 없습니다.',
        errorMessage: '교육 환류 화면을 불러오지 못했습니다.',
    }),
    ...
    'predictive-analysis': createMeta({
        ...
        productGroup: 'analytics',
        practitionerLabel: '선행 위험신호 분석',
        workerLabel: '위험신호 보기',
        developerLabel: 'Leading Risk Signal Analysis',
        description: '반복 위험신호와 조치 우선순위를 확인합니다.',
        menuVisibleInPractitionerMode: true,
        menuVisibleInWorkerMode: false,
        menuVisibleInDeveloperMode: true,
        fallbackTitle: '선행 위험신호 분석',
        emptyStateMessage: '분석할 데이터가 부족합니다.',
        errorMessage: '위험신호 분석을 불러오지 못했습니다.',
    }),
    ...
    'feedback': createMeta({
        ...
        workerLabel: '안내 및 의견',
        developerLabel: '운영 진단 · 피드백',
        description: '개발·운영 진단 모드에서 개선 제안과 전송 상태를 확인합니다.',
    ...
    'a4-education-material': createMeta({
        id: 'a4-education-material', productGroup: 'tbm', practitionerLabel: '위험성평가 교육자료', workerLabel: '위험성평가 교육', developerLabel: 'Risk Assessment Education Studio',
        description: '위험성평가 기록과 교육 원문을 근거로 전파교육용 한 장 자료를 만들고 PDF·PPTX로 저장합니다.', menuVisibleInPractitionerMode: true, menuVisibleInWorkerMode: false, menuVisibleInDeveloperMode: true,
        fallbackTitle: '위험성평가 교육자료', emptyStateMessage: '자료를 추가하거나 기본 보기글로 교육자료를 만들 수 있습니다.', errorMessage: '위험성평가 교육자료 스튜디오를 불러오지 못했습니다.',
    }),
    'ppt-pdf-one-page-summary': createMeta({
        ...
        description: '기존 주소를 원페이지 위험성평가 교육자료 스튜디오로 연결합니다.', menuVisibleInPractitionerMode: false, menuVisibleInWorkerMode: false, menuVisibleInDeveloperMode: false,
    ...
    'safety-compliance-hub': createMeta({
        ...
        productGroup: 'risk-assessment',
        practitionerLabel: '안전조치 통합 허브',
        workerLabel: '현장 상황 확인',
        developerLabel: 'Field Safety Compliance Hub',
        description: '현장 위험신호, 준수 상태, 개선조치와 코칭 흐름을 한곳에서 확인합니다.',
        menuVisibleInPractitionerMode: true,
        menuVisibleInWorkerMode: false,
        menuVisibleInDeveloperMode: true,
        fallbackTitle: '안전조치 통합 허브',
