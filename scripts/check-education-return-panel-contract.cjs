...
const required = [
  ...
  ['pages/EducationReturn.tsx', files.page, "onNavigateToPage('admin-training')"],
  ...
  ['pages/MonthlyGuidanceReport.tsx', files.monthlyGuidance, 'psi-section-title'],
  ...
  ['styles.css', files.styles, '.psi-page-title'],
  ['styles.css', files.styles, '.psi-card-title'],
  ['styles.css', files.styles, 'letter-spacing: 0;'],
