...
- 과금 전환: 무료 키의 공급자 429에서 즉시 중단하고, 파일명·예상비용·최대비용을 확인한 관리자의 문서별 승인이 있을 때만 유료 키로 1회 재요청
- 금지 경로: 인증 오류, 잘못된 요청, 네트워크·서버 장애, 애플리케이션 자체 분당·일일 제한에서는 유료 키를 제안하거나 자동 사용하지 않음
