...
6. **`06_newpsi_multilingual_a4.png` (다국어 원페이지 교육자료 환류)**
   * **기능:** 다음 달 원페이지 위험성평가 교육자료
   * **설명:** 도출된 고위험 항목 및 계도 사항을 다국어(영어, 베트남어, 태국어 등)로 번역하여 다음 달 위험성평가 전파교육용 A4 1장 자료로 변환하는 스튜디오 화면.
...
* **핵심 컨셉:** 수기 위험성평가 기록지를 OCR·AI로 정밀 분석 및 6대 안전 지표 정량화 ➔ 익명화된 월간 피드백 및 다국어 A4 원페이지 자료를 통한 위험성평가 전파교육 환류.
* **특허 증빙:**
