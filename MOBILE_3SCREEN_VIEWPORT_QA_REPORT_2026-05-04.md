...
- 확인 예정 항목:
  ...
  - [ ] 하단 5탭과 iOS safe-area 동시 적용 시 탭 가림 없음
...
- 확인 예정 항목:
  ...
  - [ ] 기본 진입 `dashboard` 로드 후 첫 탭/첫 액션 접근 1탭 도달
...
- [ ] `artifacts/mobile-qa/2026-05-04/`에 16개 캡처 파일 저장 완료(기존 12 + nav 4)
